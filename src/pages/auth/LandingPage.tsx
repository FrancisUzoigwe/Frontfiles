      ...
      <div className="mt-[60px] w-full h-[auto] flex justify-center ">
        <div className="w-[93%] h-[600px] flex items-center justify-between">
          ...
          <div className="w-[47%] h-[570px] flex flex-col ">
            <div className="font-Poppins text-[35px] w-[550px] font-medium mt-[120px]">
            ...
            <div className="w-full h-[auto] flex items-center mt-[20px]">
              <div className="w-[260px] h-[80px] flex items-center justify-between">
                ...
                <Link
                  to="/signup"
                  className=" px-6 py-2 bg-purple-700 text-white font-Poppins rounded-[20px] mt-[17px]"
                >
                  Get Started
                </Link>
              </div>
            ...
            <div className="flex justify-between">
              <div className="uppercase mt-[5px]">
